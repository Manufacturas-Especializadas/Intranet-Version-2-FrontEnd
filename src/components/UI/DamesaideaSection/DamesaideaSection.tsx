...
export const DamesaideaSection = () => {
  return (
    <section className="relative overflow-hidden rounded-3xl border border-blue-100 bg-white shadow-sm xl:h-97">
      <div className="absolute inset-0 bg-linear-to-br from-blue-50/80 via-white to-sky-100/80" />
      ...
      <div className="relative grid h-full grid-cols-1 lg:grid-cols-[280px_minmax(0,1fr)]">
        <div className="relative flex min-h-90 flex-col overflow-hidden bg-linear-to-br from-[#0033a0] via-[#005bea] to-[#1699ff] p-5 text-white lg:min-h-0 lg:rounded-l-3xl">
          <div className="absolute inset-0 opacity-20">
            <div className="h-full w-full bg-[radial-linear(circle_at_20%_30%,white_1px,transparent_1px)] bg-size-[22px_22px]" />
          </div>
            ...
            <div className="rounded-3xl border border-white/25 bg-white/95 p-3 shadow-lg backdrop-blur-sm">
              <div className="flex h-40 items-center justify-center overflow-hidden rounded-2xl bg-white">
                <img
                  ...
                  alt="DaMESAidea"
                  draggable={false}
                  className="max-h-47.5 w-auto max-w-full object-contain"
                />
              </div>
            </div>
          </div>
        ...
        <div className="flex min-w-0 flex-col justify-between gap-4 p-5">
          <div className="flex flex-col gap-4 xl:flex-row xl:items-start xl:justify-between">
            <div className="min-w-0">
              ...
              <h3 className="max-w-140 text-[26px] font-bold leading-tight text-[#123f7a]">
            ...
            <a
              ...
              className="group hidden shrink-0 items-center justify-center gap-2 rounded-2xl 
              bg-linear-to-r from-[#0033a0] via-[#005bea] to-[#1769ff] px-5 py-3 text-sm 
              font-bold text-white shadow-[0_10px_24px_rgba(0,51,160,0.22)] transition 
              hover:-translate-y-0.5 hover:shadow-[0_14px_30px_rgba(0,51,160,0.30)] 
              active:scale-[0.98] focus-visible:outline-2
              focus-visible:outline-offset-2 focus-visible:outline-blue-500 xl:flex"
            >
              Ir a DaMESAidea
            ...
            {actionCards.map((card) => {
              ...
              return (
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="group relative flex min-h-30.5 items-center gap-4 overflow-hidden 
                  rounded-3xl border border-blue-100 bg-linear-to-br from-white 
                  via-blue-50/40 to-sky-50/70 p-4 shadow-sm transition hover:-translate-y-0.5 
                  hover:border-blue-300 hover:shadow-[0_12px_28px_rgba(0,91,234,0.16)] 
                  active:scale-[0.99] focus-visible:outline 
                ...
                >
                  ...
                  <div className="flex h-14 w-14 shrink-0 items-center justify-center rounded-2xl bg-linear-to-br from-blue-50 to-sky-100 text-[#0033a0] shadow-sm ring-1 ring-blue-100 transition group-hover:scale-105 group-hover:from-[#0033a0] group-hover:to-[#1769ff] group-hover:text-white group-hover:ring-blue-300">
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="group flex items-center justify-center gap-2 rounded-2xl bg-linear-to-r 
            from-[#0033a0] via-[#005bea] to-[#1769ff] px-5 py-3 text-sm font-bold 
            text-white shadow-[0_10px_24px_rgba(0,51,160,0.22)] transition 
            hover:-translate-y-0.5 hover:shadow-[0_14px_30px_rgba(0,51,160,0.30)] 
            active:scale-[0.98] focus-visible:outline
            focus-visible:outline-offset-2 focus-visible:outline-blue-500 xl:hidden"
          >
            Ir a DaMESAidea
            <ExternalLink className="h-4 w-4 transition-transform group-hover:translate-x-0.5 group-hover:-translate-y-0.5" />
          </a>
